let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `Beauty Ai Official Site\n *LINK:* https://bit.ly/BeautyCare-Ai-Bot\n\n ${Config.botname} By | *_Beauty Ai_* ✳️`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `Use Beauty Ai Bot \n\n *ʟɪɴᴋ:* https://wa.me/94753362699\n\n ${Config.botname} *_Beauty Ai_* ✳️`;
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*HEY Allen Bot V2 IS CURRENTLY ACTIVE! 👾*";
 ...
 smd({
   ...
   try {
     ...
     if (!_0x11eeb1) {
       return await _0x7587f6.reply("_Need fileName, Example: document Hamza | caption_");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://HyHamza/BYTE-MD*");
     }
