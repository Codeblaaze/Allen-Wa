...
smd({
  ...
  try {
    ...
    const _0x4c275e = await fetch("https://widipe.com/openai-db?user=Allen%20Bot%20V2&text=Be%20intelligent%20" + _0x1b0897);
...
smd({
  ...
  try {
    ...
    let _0x24d5e9 = false;
    try {
      const _0x156dd7 = await fetch("https://widipe.com/ai/text2img?text=Generation%20perfectly" + (_0x2968fd + " \nNOTE: Make sure to looks like imagination, make it short and concise, also in english!"));
